@extends('landing-page.desktop.layouts.index')
@section('content')
    ...
    <div class="container-fluid p-0 bg-image-1" id="home">
      <div class="container-overlay d-flex flex-column justify-content-center align-items-center px-5">
        ...
        <p class="fs-5 text-pop text-light w-50 text-center">Parfume dengan aroma yang diformulasikan bahan terbaiik dan pilihan. Menghasilkan aroma yang fresh serta elegan, yang membuat kamu lebih percaya diri sepanjang hari tanpa takut bau matahari.</p>
      </div>
    </div>
